...
class _MyProfileScreenState extends State<MyProfileScreen> {
  ...
  Future<void> _addProfilePhoto() async {
    ...
    try {
      final image = await pickProfilePhoto(context, _picker, source);
  ...
  Future<void> _setBreak(bool enabled, {TakeBreakChoice? choice}) async {
    ...
    if (ok && choice != null && choice.disableNotifications) {
      ...
      if (userId != null && userId.isNotEmpty) {
        ...
        final current =
            _userController.userPreferences.value ??
  ...
  List<Widget> _photoInsightBars(UserModel? user) {
    ...
    for (var i = 0; i < photos.length.clamp(0, 3); i++) {
      slots.add(
        _photoSlot(
          label: 'Pic ${i + 1}',
          imageUrl: photos[i],
  ...
  Widget _photoSlot({
    ...
    return Expanded(
      child: Padding(
        ...
        child: Column(
          children: [
            // Every slot shares the same 3:4 tile so photos and empty slots
            // line up in one even row.
            AspectRatio(
              aspectRatio: 3 / 4,
              child: Material(
                color: hasImage ? Colors.white : accent.withOpacity(0.08),
            ...
            Text(
              ...
              style: TextStyle(
                fontSize: 12,
                color: active || label == 'Add' ? accent : Colors.grey,
                fontWeight:
                    active || label == 'Add'
                        ? FontWeight.w600
                        : FontWeight.normal,
                        ...
                        if (user != null && user.interests.isNotEmpty) ...[
                          ...
                          Padding(
                            ...
                            child: Wrap(
                              ...
                              runSpacing: 8,
                              children:
                                  user.interests.take(5).map((interest) {
                                    return Container(
                                      padding: const EdgeInsets.symmetric(
                                        horizontal: 12,
                                        vertical: 6,
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        _buildTile(
                          ...
                          onTap: () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder:
                                    (context) => const SafetyToolkitScreen(),
                              ),
                            );
                          },
                        ),
                        _buildTile(
                          ...
                          onTap: () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder:
                                    (context) => const HideMyProfileScreen(),
                              ),
                            );
                          },
                        ),
                        ...
                        _buildTile(
                          ...
                          onTap: () {
                            Navigator.push(
                              ...
                              MaterialPageRoute(
                                builder:
                                    (context) => const BlockedUsersScreen(),
                              ),
                            );
                          },
                        ),
                        ...
                        Obx(() {
                          final onBreak =
                              _userController.currentUser.value?.active ==
                                  false ||
                              isBreakEnabled;
                          return Padding(
